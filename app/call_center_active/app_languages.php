...
$text['message-confirm']['zh-cn'] = "你真的想这样做吗？";
...
$text['label-tier_state']['zh-cn'] = "分层状态";
...
$text['label-status_change']['zh-cn'] = "状态更改";
...
$text['description-queue']['zh-cn'] = "下面是队列中调用方的当前列表。";
...
$text['description-agents']['zh-cn'] = "下面是代理的当前列表。";
