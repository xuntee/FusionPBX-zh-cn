...
$text['label-ring-order']['zh-cn'] = "环订单";
...
$text['label-prompt']['zh-cn'] = "提示接受呼叫";
...
$text['label-cid-number-prefix']['zh-cn'] = "数字前缀";
...
$text['description-on-busy']['zh-cn'] = "如果启用，它将覆盖扩展中启用语音邮件的值。";
...
$text['description-no_answer']['zh-cn'] = "如果启用，它将覆盖扩展中启用语音邮件的值。";
...
$text['description-ignore_busy']['zh-cn'] = "如果目的地忙，请中断呼叫。";
...
$text['description-cid-number-prefix']['zh-cn'] = "设置呼叫者ID号码前缀。";
