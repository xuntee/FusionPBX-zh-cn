...
$text['title-call_groups']['zh-cn'] = "调用组";
...
$text['label-toll_allow']['zh-cn'] = "允许通行费";
...
$text['label-cidr']['zh-cn'] = "计算机辅助设计语言";
...
$text['description-extension']['zh-cn'] = "输入字母数字扩展名。默认配置允许2-15位的扩展。";
...
$text['description-cidr']['zh-cn'] = "在这里输入苹果酒。";
