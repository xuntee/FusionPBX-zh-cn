...
$text['description']['zh-cn'] = "会议用于设置具有名称、说明和可选PIN号的会议室。";
...
$text['button-view_active']['zh-cn'] = "活动视图";
...
$text['confirm-delete-2']['zh-cn'] = "是否确实要删除此？";
...
$text['description-flags']['zh-cn'] = "可选会议标志。示例：静音聋浪费调节器";
