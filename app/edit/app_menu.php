<?php
	...
	$y=0;
	$apps[$x]['menu'][$y]['title']['zh-cn'] = "Script Editor";
	...
	$y++;
	$apps[$x]['menu'][$y]['title']['zh-cn'] = "XML Editor";
	...
	$apps[$x]['menu'][$y]['groups'][] = "superadmin";
	$y++;
	$apps[$x]['menu'][$y]['title']['zh-cn'] = "Provision Editor";
	...
	$apps[$x]['menu'][$y]['groups'][] = "superadmin";
	$y++;
	$apps[$x]['menu'][$y]['title']['zh-cn'] = "PHP Editor";
	...
	$apps[$x]['menu'][$y]['groups'][] = "superadmin";
	$y++;
	$apps[$x]['menu'][$y]['title']['zh-cn'] = "Grammar Editor";
