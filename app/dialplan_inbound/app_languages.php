...
$text['title-dialplan-inbound-add']['zh-cn'] = "Inbound Call Routing";
...
$text['label-select-inbound-destination-number']['zh-cn'] = "Select the inbound destination number.";
...
$text['label-required-domain_uuid']['zh-cn'] = "Please provide: domain_uuid";
...
$text['label-required-condition_field_1']['zh-cn'] = "Please provide: Condition Field";
...
$text['label-required-condition_expression_1']['zh-cn'] = "Please provide: Condition Expression";
...
$text['label-required-action_application_1']['zh-cn'] = "Please provide: Action Application";
...
$text['label-caller-id-number-prefix']['zh-cn'] = "Caller ID Number Prefix";
...
$text['label-access-denied']['zh-cn'] = "access denied";
...
$text['description-caller-id-number-prefix']['zh-cn'] = "Set a prefix on the caller ID number.";
...
$text['description-name']['zh-cn'] = "Please enter an inbound route name.";
...
$text['description-dialplan-inbound-add']['zh-cn'] = "The public dialplan is used to route incoming calls to destinations based on one or more conditions and context. It can send incoming calls to an auto attendant, huntgroup, extension, external number, or a script.";
...
$text['confirm-update-complete']['zh-cn'] = "Update Complete";
