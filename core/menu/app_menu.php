<?php
	$y=0;
	$apps[$x]['menu'][$y]['title']['zh-cn'] = "Menu Manager";
	...
	$y++;
	$apps[$x]['menu'][$y]['title']['zh-cn'] = "Home";
	...
	$apps[$x]['menu'][$y]['groups'][] = "superadmin";
	$y++;
	$apps[$x]['menu'][$y]['title']['zh-cn'] = "Accounts";
	...
	$apps[$x]['menu'][$y]['groups'][] = "superadmin";
	$y++;
	$apps[$x]['menu'][$y]['title']['zh-cn'] = "Status";
	...
	$apps[$x]['menu'][$y]['groups'][] = "superadmin";
	$y++;
	$apps[$x]['menu'][$y]['title']['zh-cn'] = "Advanced";
	...
	$apps[$x]['menu'][$y]['groups'][] = "superadmin";
	$y++;
	$apps[$x]['menu'][$y]['title']['zh-cn'] = "Login";
	...
	$y++;
	$apps[$x]['menu'][$y]['title']['zh-cn'] = 'Logout';
	$apps[$x]['menu'][$y]['title']['ar-eg'] = "";
